    ...
    return (
        <section id="aboutme">
            <div className='mt-5 mx-md-5'>
                <p className='lead'>
                    I am a self-taught programmer. I have honed my skills in programming languages such as
                    <b> HTML</b>,<b> CSS</b> and <b>JavaScript</b> and have experience in front-end frameworks
                    <b>React.js</b> through taking online courses and completing personal projects.<br />
                    <br />
                    ...
                    presents and I am ready to contribute to the continuously growing industry.</p>
            </div>
        </section>
    );
}
